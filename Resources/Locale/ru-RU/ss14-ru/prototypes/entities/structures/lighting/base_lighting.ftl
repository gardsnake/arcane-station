...
ent-EmergencyLight = аварийная лампа
    .desc = Маленькая лампочка с внутренним аккумулятором, оповещающая экипаж об обстановке на станции. Оснащена динамиком для звуковых оповещений.
...
ent-AlwaysPoweredlightGreen = { ent-AlwaysPoweredWallLight }
    ...
    .desc = { ent-AlwaysPoweredWallLight.desc }
ent-SmallFloorLightMiddleEmpty = маленький напольный светильник
    .desc = Маленький напольный светильник. Что ты ищешь тут? Тут не на что смотреть!
ent-FloorLightMiddleEmpty = длинный напольный светильник (центр)
    .desc = Длинный напольный светильник. Что ты ищешь тут? Тут не на что смотреть!
ent-FloorLightSideEmpty = длинный напольный светильник (края)
    .desc = Длинный напольный светильник. Что ты ищешь тут? Тут не на что смотреть!
ent-SmallFloorLightMiddle = маленький напольный светильник
    .desc = Маленький напольный светильник. Что ты ищешь тут? Тут не на что смотреть!
ent-FloorLightMiddle = длинный напольный светильник (центр)
    .desc = Длинный напольный светильник. Что ты ищешь тут? Тут не на что смотреть!
ent-FloorLightSide = длинный напольный светильник (края)
    .desc = Длинный напольный светильник. Что ты ищешь тут? Тут не на что смотреть!
